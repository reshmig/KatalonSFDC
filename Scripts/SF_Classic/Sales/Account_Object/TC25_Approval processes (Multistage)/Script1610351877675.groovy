...
WebUI.enhancedClick(findTestObject('SF_Classic/Sales/Account_Object/TC25_Approval processes (Multistage)/Click on unlock'))
...
WebUI.selectOptionByValue(findTestObject('SF_Classic/Sales/Account_Object/TC25_Approval processes (Multistage)/Select rating'), 
    'Warm', false)

WebUI.selectOptionByValue(findTestObject('SF_Classic/Sales/Account_Object/TC25_Approval processes (Multistage)/Select type'), 
    'Prospect', false)
...
WebUI.verifyElementPresent(findTestObject('SF_Classic/Sales/Account_Object/TC25_Approval processes (Multistage)/Verify auto approve'), 
    5)
