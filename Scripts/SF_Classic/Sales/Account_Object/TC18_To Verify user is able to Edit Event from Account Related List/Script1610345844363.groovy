...
WebUI.enhancedClick(findTestObject('SF_Classic/Sales/Account_Object/TC18_To Verify user is able to Edit Event from Account Related List/click on edit'))

WebUI.delay(5)

WebUI.setText(findTestObject('SF_Classic/Sales/Account_Object/TC18_To Verify user is able to Edit Event from Account Related List/Set value to des'), 
    'Value for event')
