...
WebUI.enhancedClick(findTestObject('SF_Classic/Sales/Account_Object/TC07_To verify user is able create New Contact from Account Related List/Click on New contact'))

WebUI.delay(5)

WebUI.selectOptionByValue(findTestObject('SF_Classic/Sales/Contacts_Object/TC01_NewContract/salutation'), 'Mrs.', false)

WebUI.setText(findTestObject('SF_Classic/Sales/Contacts_Object/TC01_NewContract/lastname'), 'AccContact')

WebUI.click(findTestObject('SF_Classic/Sales/Contacts_Object/TC01_NewContract/save'))

WebUI.delay(5)

WebUI.verifyElementPresent(findTestObject('SF_Classic/Sales/Account_Object/TC07_To verify user is able create New Contact from Account Related List/Verify account'), 
    5)
...
WebUI.verifyElementPresent(findTestObject('SF_Classic/Sales/Account_Object/TC07_To verify user is able create New Contact from Account Related List/Verify contact'), 
    5)
