...
WebUI.enhancedClick(findTestObject('SF_Classic/Sales/Account_Object/TC21_To verify user is able Edit case from Account Related List/Click edit'))

WebUI.delay(5)

WebUI.selectOptionByValue(findTestObject('SF_Classic/Sales/Account_Object/TC21_To verify user is able Edit case from Account Related List/Seleect status'), 
    'Working', false)
...
WebUI.verifyElementPresent(findTestObject('SF_Classic/Sales/Account_Object/TC21_To verify user is able Edit case from Account Related List/Verify case'), 
    5)
