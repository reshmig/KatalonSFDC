...
WebUI.enhancedClick(findTestObject('SF_Classic/Sales/Account_Object/TC19_To Verify user is able to Delete Event from Account Related List/Click on Delete'))

WebUI.acceptAlert()

WebUI.delay(5)

WebUI.verifyElementNotPresent(findTestObject('SF_Classic/Sales/Account_Object/TC17_To Verify user is able to create new Event from Account Related List/Verify event'), 
    5)
