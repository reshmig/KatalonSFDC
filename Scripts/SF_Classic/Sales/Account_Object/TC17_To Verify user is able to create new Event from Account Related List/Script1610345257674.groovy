...
WebUI.enhancedClick(findTestObject('SF_Classic/Sales/Account_Object/TC17_To Verify user is able to create new Event from Account Related List/Click on new event'))

WebUI.delay(5)

WebUI.setText(findTestObject('SF_Classic/Sales/Account_Object/TC17_To Verify user is able to create new Event from Account Related List/Set subject'), 
    'Meeting')
...
WebUI.verifyElementPresent(findTestObject('SF_Classic/Sales/Account_Object/TC17_To Verify user is able to create new Event from Account Related List/Verify event'), 
    5)
