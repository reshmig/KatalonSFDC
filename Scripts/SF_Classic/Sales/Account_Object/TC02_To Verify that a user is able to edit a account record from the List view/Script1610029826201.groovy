...
WebUI.enhancedClick(findTestObject('SF_Classic/Sales/Account_Object/TC02_To Verify that a user is able to edit a account record from the List view/CLick Edit'))
...
WebUI.verifyElementPresent(findTestObject('SF_Classic/Sales/Account_Object/TC02_To Verify that a user is able to edit a account record from the List view/Verify account'), 
    5)
