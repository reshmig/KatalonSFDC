...
WebUI.enhancedClick(findTestObject('SF_Classic/Sales/Account_Object/TC15_To Verify user is able to Edit new task from Account Related List/Click on Edit'))

WebUI.delay(5)

WebUI.selectOptionByValue(findTestObject('SF_Classic/Sales/Account_Object/TC15_To Verify user is able to Edit new task from Account Related List/Select value'), 
    'In Progress', false)
