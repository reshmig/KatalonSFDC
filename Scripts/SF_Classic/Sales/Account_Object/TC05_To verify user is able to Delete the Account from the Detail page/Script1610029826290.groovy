...
WebUI.enhancedClick(findTestObject('SF_Classic/Sales/Account_Object/TC05_To verify user is able to Delete the Account from the Detail page/Click on delete'))

WebUI.acceptAlert()

WebUI.delay(5)

WebUI.verifyElementNotPresent(findTestObject('SF_Classic/Sales/Account_Object/TC05_To verify user is able to Delete the Account from the Detail page/Click on Acc name'), 
    5)
