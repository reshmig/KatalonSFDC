...
WebUI.setText(findTestObject('SF_Classic/Sales/Account_Object/TC23_Submmiting a account for approval/Billing street'), 'Test-Billing Street')
...
WebUI.enhancedClick(findTestObject('SF_Classic/Sales/Account_Object/TC23_Submmiting a account for approval/Submit for approval'))

WebUI.acceptAlert()

WebUI.delay(5)

WebUI.verifyElementPresent(findTestObject('SF_Classic/Sales/Account_Object/TC23_Submmiting a account for approval/Verify approval status'), 
    5)
