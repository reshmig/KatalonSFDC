...
WebUI.enhancedClick(findTestObject('SF_Classic/Sales/Account_Object/TC11_To verify user is able Edit Opportunity from Account Related List/Click on edit of opp'))

WebUI.delay(5)

WebUI.setText(findTestObject('SF_Classic/Sales/Account_Object/TC11_To verify user is able Edit Opportunity from Account Related List/Add description'), 
    'Test for Opp from Account')
