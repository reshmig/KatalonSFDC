...
WebUI.enhancedClick(findTestObject('SF_Classic/Sales/Account_Object/TC12_To verify user is able Delete Opportunity from Account Related List/Click on Opp delete'))

WebUI.acceptAlert()

WebUI.delay(5)

WebUI.verifyElementNotPresent(findTestObject('SF_Classic/Sales/Account_Object/TC10_To verify user is able create New opportunity from Account Related List/Verify opp'), 
    5)
