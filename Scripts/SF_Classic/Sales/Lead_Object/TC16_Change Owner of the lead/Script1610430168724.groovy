...
WebUI.click(findTestObject('SF_Classic/Sales/Lead_Object/Obj16_Change Owner of the lead/Lead_Change Owner'))

WebUI.setText(findTestObject('SF_Classic/Sales/Lead_Object/Obj16_Change Owner of the lead/Lead_ChangeOwner_User Name'), 
    'James Clifton')
