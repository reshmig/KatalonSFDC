...
WebUI.setText(findTestObject('SF_Classic/Sales/Lead_Object/Obj13_Convert lead with Opportunity/Lead_Convert_Comment'), 'Test_Lead created with Opportunity with Task')
