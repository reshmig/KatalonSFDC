...
WebUI.click(findTestObject('SF_Classic/Sales/Lead_Object/Obj04_Create Task from Lead Related List/Lead_RL_New Task B'))
...
WebUI.verifyTextPresent('Test_Subject_Call', false)

WebUI.click(findTestObject('SF_Classic/Sales/Lead_Object/Obj06_Close and Delete New Task from Lead Related List/Lead_RL_Task_Close B'))
