...
WebUI.click(findTestObject('SF_Classic/Sales/Lead_Object/Obj10_Create an Event from Lead Related List/Lead_RL_New Event B'))

WebUI.setText(findTestObject('SF_Classic/Sales/Lead_Object/Obj10_Create an Event from Lead Related List/Lead_RL_Event_Subject'), 
    'Event 01')

WebUI.setText(findTestObject('SF_Classic/Sales/Lead_Object/Obj10_Create an Event from Lead Related List/Lead_RL_Event_Start Date'), 
    '2/2/2021')

WebUI.setText(findTestObject('SF_Classic/Sales/Lead_Object/Obj10_Create an Event from Lead Related List/LEads_RL_Event_Start Time'), 
    '10:00 AM')

WebUI.setText(findTestObject('SF_Classic/Sales/Lead_Object/Obj10_Create an Event from Lead Related List/Lead_RL_Event_End Date'), 
    '2/2/2021')

WebUI.setText(findTestObject('SF_Classic/Sales/Lead_Object/Obj10_Create an Event from Lead Related List/LEads_RL_Event_End Time'), 
    '10:30 AM')
...
WebUI.verifyTextPresent('Event 01', false)

WebUI.delay(3)

WebUI.click(findTestObject('SF_Classic/Sales/Lead_Object/Obj06_Close and Delete New Task from Lead Related List/Lead_RL_Task_Delete'))
