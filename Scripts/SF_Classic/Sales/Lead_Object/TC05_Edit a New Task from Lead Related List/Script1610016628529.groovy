...
WebUI.click(findTestObject('SF_Classic/Sales/Lead_Object/Obj05_Edit a New Task from Lead Related List/Lead_RL_Task_Edit B_1st iTem'))

WebUI.setText(findTestObject('SF_Classic/Sales/Lead_Object/Obj04_Create Task from Lead Related List/Lead_RL_Task_Subject'), 
    'Test_Subject_Updated Call')
...
WebUI.verifyTextPresent('Test_Subject_Updated Call', false)
