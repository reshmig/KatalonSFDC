...
WebUI.click(findTestObject('SF_Classic/Sales/Lead_Object/Obj15_Convert lead without Opportunity with Task/Lead_Convert_Checkbox'))
...
WebUI.setText(findTestObject('SF_Classic/Sales/Lead_Object/Obj13_Convert lead with Opportunity/Lead_Convert_Comment'), 'Test_Lead created without Opportunity with Task')
