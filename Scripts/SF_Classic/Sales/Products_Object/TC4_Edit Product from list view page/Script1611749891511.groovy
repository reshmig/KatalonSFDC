...
WebUI.click(findTestObject('SF_Classic/Sales/Products_Object/Obj04_Edit Product from the list view page/Product Views Go'))

WebUI.click(findTestObject('SF_Classic/Sales/Products_Object/Obj04_Edit Product from the list view page/Edit Product link'))
...
WebUI.verifyTextPresent('QA Katalon1Editlistview', false)
