...
WebUI.click(findTestObject('SF_Classic/Sales/Opportunity_Object/Obj9_Edit Product from Detail Page/Product record'))

WebUI.click(findTestObject('SF_Classic/Sales/Opportunity_Object/Obj9_Edit Product from Detail Page/Edit button'))
