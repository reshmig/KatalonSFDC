...
WebUI.click(findTestObject('SF_Classic/Sales/Opportunity_Object/Obj06_Add Product to Opportunity(Change of Prcie Book)/Choose Price Book button'))

WebUI.click(findTestObject('SF_Classic/Sales/Opportunity_Object/Obj06_Add Product to Opportunity(Change of Prcie Book)/Price Book dropdown'))

WebUI.selectOptionByLabel(findTestObject('SF_Classic/Sales/Opportunity_Object/Obj06_Add Product to Opportunity(Change of Prcie Book)/Price Book dropdown'), 
    'Price Book SH', false)

WebUI.click(findTestObject('SF_Classic/Sales/Opportunity_Object/Obj06_Add Product to Opportunity(Change of Prcie Book)/Save'))
