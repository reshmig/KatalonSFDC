...
WebUI.click(findTestObject('SF_Classic/Sales/Opportunity_Object/Obj10_Delete Product from Opprtunity Related List/Delete button'))

WebUI.acceptAlert()

WebUI.verifyTextNotPresent('Product SH1', false)
