...
WebUI.click(findTestObject('SF_Classic/Sales/Reports for Opportunity/Obj05_Create a Report for Opportunities with Competitions/Reports tab'))

WebUI.click(findTestObject('SF_Classic/Sales/Reports for Opportunity/Obj05_Create a Report for Opportunities with Competitions/New Report button'))

WebUI.click(findTestObject('SF_Classic/Sales/Reports for Opportunity/Obj05_Create a Report for Opportunities with Competitions/Opportunity maximize button'))

WebUI.enhancedClick(findTestObject('SF_Classic/Sales/Reports for Opportunity/Obj05_Create a Report for Opportunities with Competitions/Opportunity with Competitions Type'))
...
WebUI.sendKeys(findTestObject('SF_Classic/Sales/Reports for Opportunity/Obj04_Create a report for Opportunities with Partners/Report Name'), 
    'Opportunity with Competitions Report')
...
WebUI.verifyTextPresent('Opportunity with Competitions Report', false)
