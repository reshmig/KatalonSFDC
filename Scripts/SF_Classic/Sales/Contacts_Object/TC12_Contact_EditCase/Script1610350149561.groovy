...
WebUI.click(findTestObject('SF_Classic/Sales/Contacts_Object/TC12_Contact_EditCase/edit'))

WebUI.setText(findTestObject('SF_Classic/Sales/Contacts_Object/TC11_Contact_NewCase/subject'), 'Katalon_Casetestupdated')

WebUI.click(findTestObject('SF_Classic/Sales/Contacts_Object/TC08_Contact_NewOpportunity/save'))

WebUI.delay(3)

WebUI.verifyTextPresent('Katalon_Casetestupdated', false)
