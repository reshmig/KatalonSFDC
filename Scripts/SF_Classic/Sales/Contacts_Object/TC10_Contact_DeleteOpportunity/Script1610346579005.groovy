...
WebUI.click(findTestObject('SF_Classic/Sales/Contacts_Object/TC10_Contact_DeleteOpportunity/delete'))
...
WebUI.verifyTextNotPresent('Opportunity_Katalon_autoupdated', false)
