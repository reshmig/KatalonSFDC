...
WebUI.click(findTestObject('SF_Classic/Sales/Pricebook_Object/Obj04_Deletion of line item in Pricebook/Delete link of line item'))

WebUI.acceptAlert()

WebUI.verifyTextNotPresent('GenWatt Diesel 10kW', false)
