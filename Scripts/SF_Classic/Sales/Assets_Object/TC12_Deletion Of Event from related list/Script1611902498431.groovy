...
WebUI.click(findTestObject('SF_Classic/Sales/Assets_Object/Obj12_Deletion of Event from the Related List/Delete Link'))

WebUI.acceptAlert()

WebUI.delay(5)

WebUI.verifyTextNotPresent('Event edited using KATALON', false)
