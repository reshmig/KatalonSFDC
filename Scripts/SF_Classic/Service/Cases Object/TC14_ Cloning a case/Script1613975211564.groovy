...
WebUI.click(findTestObject('SF_Classic/Service/Cases Object/TC14_ Cloning a case/Clone Button'))

WebUI.setText(findTestObject('SF_Classic/Service/Cases Object/TC01_Creation of Cases/Subject Field'), 'Cloned Using Katalon')

WebUI.setText(findTestObject('SF_Classic/Service/Cases Object/TC01_Creation of Cases/Description'), 'THIS CASE IS CLONED USING KATALON PLEASE DONT DELETE ')
