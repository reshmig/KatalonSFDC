...
WebUI.click(findTestObject('SF_Classic/Service/Contracts Object/TC01_ Creating a Contract/New button'))

WebUI.setText(findTestObject('SF_Classic/Service/Contracts Object/TC01_ Creating a Contract/Account Name'), 'Katalon new Account')

WebUI.setText(findTestObject('SF_Classic/Service/Contracts Object/TC01_ Creating a Contract/Contract Start Date Field'), 
    '2/24/2021')

WebUI.setText(findTestObject('SF_Classic/Service/Contracts Object/TC01_ Creating a Contract/Contract Term field'), '30')
