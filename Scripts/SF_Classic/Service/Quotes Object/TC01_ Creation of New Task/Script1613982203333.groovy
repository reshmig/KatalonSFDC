...
WebUI.click(findTestObject('SF_Classic/Service/Quotes Object/TC01_ Creation of New Task/New Task button'))

WebUI.selectOptionByValue(findTestObject('SF_Classic/Service/Quotes Object/TC01_ Creation of New Task/Status Picklist'), 
    'In Progress', false)

WebUI.setText(findTestObject('SF_Classic/Service/Quotes Object/TC01_ Creation of New Task/Subject Field'), 'THIS TASK IS CREATED USING KATALON')

WebUI.setText(findTestObject('SF_Classic/Service/Quotes Object/TC01_ Creation of New Task/Comments Field'), 'THIS RECORD IS CREATED USING KATALON PLEAS DONT DELETE IT ')
