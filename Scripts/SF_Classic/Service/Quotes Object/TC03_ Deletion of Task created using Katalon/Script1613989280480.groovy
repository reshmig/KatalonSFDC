...
WebUI.click(findTestObject('SF_Classic/Service/Quotes Object/TC03_ Deletion of task created using Katalon/Task Record Link'))

WebUI.click(findTestObject('SF_Classic/Service/Quotes Object/TC03_ Deletion of task created using Katalon/Delete Button Detail Page'))
