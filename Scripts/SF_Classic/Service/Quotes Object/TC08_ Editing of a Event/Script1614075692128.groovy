...
WebUI.click(findTestObject('SF_Classic/Service/Quotes Object/TC08_ Editing of a Event/Edit Link'))

WebUI.setText(findTestObject('SF_Classic/Service/Quotes Object/TC07_ Creating New event/Subject Field'), 'EVENT edited USING KATALON')

WebUI.setText(findTestObject('SF_Classic/Service/Quotes Object/TC07_ Creating New event/Description Field'), 'THIS RECORD IS edited USING KATALON. PLEASE DONT DELETE')
