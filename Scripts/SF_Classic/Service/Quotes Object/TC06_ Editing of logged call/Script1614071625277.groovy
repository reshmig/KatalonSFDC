...
WebUI.click(findTestObject('SF_Classic/Service/Quotes Object/TC06_ Editing a logged call/Edit Link'))

WebUI.setText(findTestObject('SF_Classic/Service/Quotes Object/TC04_ Logging of Call in Activities/Subject Field'), 'Call edited by Katalon')

WebUI.setText(findTestObject('SF_Classic/Service/Quotes Object/TC04_ Logging of Call in Activities/Comments Field'), 'THIS CALL IS edited USING KATALON ')
