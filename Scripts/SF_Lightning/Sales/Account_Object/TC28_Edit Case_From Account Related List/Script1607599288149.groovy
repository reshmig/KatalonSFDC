...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj28_Edit Case_From Account Related List/Account_RL_Case_Drop Down'))

WebUI.click(findTestObject('SF_Lightning/Sales/Account_Object/Obj28_Edit Case_From Account Related List/Account_RL_Case_DD_Edit'))

WebUI.setText(findTestObject('SF_Lightning/Sales/Account_Object/Obj26_Create Case_From Account Related List/Account_RL_Cases_Description'), 
    'Case UPDATED successfully from Account related list')
