...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj20_Create a task_From Account Details Page/Account_New Task tab'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj20_Create a task_From Account Details Page/Account_New Task_Create Task_Add'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj19_Log a Call_From Account Details Page/Account_Log a Call_Save B'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj01_Account_Add_Manual/span_Accounts_Tab'))

WebUI.click(findTestObject('SF_Lightning/Sales/Account_Object/Obj04_Account_Edit_From Record Details page/Account_RV_Open 1st Record'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj21_Edit task_From Account Details Activity tab/Account_Edit Task_Drop Down'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj22_Delete Task_From Account Details Activity tab/Account_Edit Task_DD_Delete B'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj22_Delete Task_From Account Details Activity tab/Account_Edit Task_DD_Delete_Delete B'))
