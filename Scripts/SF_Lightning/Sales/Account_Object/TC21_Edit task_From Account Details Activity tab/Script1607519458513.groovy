...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj21_Edit task_From Account Details Activity tab/Account_Edit Task_DD_Edit B'))
...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj21_Edit task_From Account Details Activity tab/Account_Edit Task_DD_Edit_Save'))
