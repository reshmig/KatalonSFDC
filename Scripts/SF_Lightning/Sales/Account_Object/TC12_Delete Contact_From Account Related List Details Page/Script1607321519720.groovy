...
WebUI.click(findTestObject('SF_Lightning/Sales/Account_Object/Obj10_Edit Contact_From Account Related List Details Page/Account_RL_Contact_DD'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj10_Edit Contact_From Account Related List Details Page/Account_RL_Contact_DD_Delete Button'))
