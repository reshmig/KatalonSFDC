...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj14_Edit Opp_From Account Related List/Account_RL_Opp_Drop-Down'))
...
WebUI.setText(findTestObject('SF_Lightning/Sales/Account_Object/Obj13_Create Opp_From Account Related List/Account_RL_Opp_Details P_Description'), 
    'Opp UPDATED successfully from Acc RL.')

WebUI.click(findTestObject('SF_Lightning/Sales/Account_Object/Obj14_Edit Opp_From Account Related List/Account_RL_Opp_Edit_Save B'))
