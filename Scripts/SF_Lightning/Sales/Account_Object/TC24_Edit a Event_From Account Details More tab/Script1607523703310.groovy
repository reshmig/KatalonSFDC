...
WebUI.setText(findTestObject('SF_Lightning/Sales/Account_Object/Obj24_Edit a Event_From Account Details More tab/Account_Edit Event_Description'), 
    'Event UPDATED from Account details tab')
