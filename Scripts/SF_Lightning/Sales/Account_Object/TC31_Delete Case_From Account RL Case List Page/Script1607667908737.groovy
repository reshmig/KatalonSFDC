...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj29_Edit Case_From Account RL Case List view/Account_RL_Case_ListView_Drop-Down'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj16_Delete Opp_From Account Related List/Account_RL_Opp_DD_Delete'))
