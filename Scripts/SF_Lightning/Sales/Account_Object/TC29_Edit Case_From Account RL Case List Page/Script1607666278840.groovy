...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj26_Create Case_From Account Related List/Account_RL_Cases_Header Link'))

WebUI.refresh()

WebUI.click(findTestObject('SF_Lightning/Sales/Account_Object/Obj26_Create Case_From Account Related List/Account_RL_Cases_New B'))
...
WebUI.setText(findTestObject('SF_Lightning/Sales/Account_Object/Obj26_Create Case_From Account Related List/Account_RL_Cases_Subject'), 
    'Test_Case Created from Account RL')
...
WebUI.setText(findTestObject('SF_Lightning/Sales/Account_Object/Obj26_Create Case_From Account Related List/Account_RL_Cases_Description'), 
    'Case created successfully from Account related list')
...
WebUI.click(findTestObject('SF_Lightning/Sales/Account_Object/Obj26_Create Case_From Account Related List/Account_RL_Cases_Save B'))

WebUI.click(findTestObject('SF_Lightning/Sales/Account_Object/Obj29_Edit Case_From Account RL Case List view/Account_RL_Case_ListView_Drop-Down'))

WebUI.click(findTestObject('SF_Lightning/Sales/Account_Object/Obj29_Edit Case_From Account RL Case List view/Account_RL_Case_ListView_DD_Edit'))

WebUI.setText(findTestObject('SF_Lightning/Sales/Account_Object/Obj26_Create Case_From Account Related List/Account_RL_Cases_Description'), 
    'Case Updated successfully from Account related list Case list view page')

WebUI.click(findTestObject('SF_Lightning/Sales/Account_Object/Obj27_Create Case_From Account Details Page/Account_New Case_Save'))
