...
WebUI.click(findTestObject('SF_Lightning/Sales/Account_Object/Obj27_Create Case_From Account Details Page/Account_New Case B'))

WebUI.setText(findTestObject('SF_Lightning/Sales/Account_Object/Obj27_Create Case_From Account Details Page/Account_New Case_Subject'), 
    'Test_Case Created from Account details page')

WebUI.setText(findTestObject('SF_Lightning/Sales/Account_Object/Obj27_Create Case_From Account Details Page/Account_New Case_Description'), 
    'Case created successfully from Account details page')
