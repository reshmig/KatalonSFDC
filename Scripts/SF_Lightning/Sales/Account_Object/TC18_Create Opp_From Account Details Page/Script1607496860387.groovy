...
WebUI.click(findTestObject('SF_Lightning/Sales/Account_Object/Obj18_Create Opp_From Account Details Page/Account_New Opp Button'))

WebUI.setText(findTestObject('SF_Lightning/Sales/Account_Object/Obj18_Create Opp_From Account Details Page/Account_Opp_Details P_Opp Name'), 
    'Test_Opp_From Acc RL')

WebUI.setText(findTestObject('SF_Lightning/Sales/Account_Object/Obj18_Create Opp_From Account Details Page/Account_Opp_Details P_Closed Date'), 
    '1/9/2021')
...
WebUI.setText(findTestObject('SF_Lightning/Sales/Account_Object/Obj18_Create Opp_From Account Details Page/Account_Opp_Amount'), 
    '300')

WebUI.click(findTestObject('SF_Lightning/Sales/Account_Object/Obj18_Create Opp_From Account Details Page/Account_Opp_Save B'))
