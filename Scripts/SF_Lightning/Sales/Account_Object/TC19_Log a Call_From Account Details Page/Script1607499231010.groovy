...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj19_Log a Call_From Account Details Page/Account_Log a Call tab'))

WebUI.setText(findTestObject('SF_Lightning/Sales/Account_Object/Obj19_Log a Call_From Account Details Page/Account_Log a Call_Comment'), 
    'Logging a call from Account')

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj19_Log a Call_From Account Details Page/Account_Log a Call_Name list'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Account_Object/Obj05_Account_Change Owner_From Record Details page/Account_Change Owner_1st Value Selected'))
