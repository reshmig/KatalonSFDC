...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC19_Edit product from product drop down label/Click on the edit product button from dropdown'))
