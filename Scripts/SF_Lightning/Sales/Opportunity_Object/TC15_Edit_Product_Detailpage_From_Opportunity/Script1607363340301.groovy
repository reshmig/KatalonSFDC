...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC15_Edit_Prodct_from_Opportunity/Click on the product name'))

WebUI.delay(5)

WebUI.click(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC15_Edit_Prodct_from_Opportunity/Click on Edit button from detail page'))

WebUI.delay(2)

WebUI.scrollToElement(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC15_Edit_Prodct_from_Opportunity/Quantity label identification to scroll'), 
    2)
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC15_Edit_Prodct_from_Opportunity/Verify product is present'), 
    3)
