...
WebUI.click(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC08_Opportunity_ToChangeOwner_ListView/select 1st row dropdown'))

WebUI.click(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC08_Opportunity_ToChangeOwner_ListView/Click change owner from drop down'))
...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC08_Opportunity_ToChangeOwner_ListView/Select the owner'))
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC08_Opportunity_ToChangeOwner_ListView/Verify owner'), 
    5)
