...
WebUI.click(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC16_Delete_product_from_detailpage/Click on the delete button'))

WebUI.click(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC16_Delete_product_from_detailpage/Click on delete from pop up'))

WebUI.delay(2)

WebUI.verifyElementNotPresent(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC17_Editproductfromexistingproductdropdown/Verify product element present or not'), 
    3)
