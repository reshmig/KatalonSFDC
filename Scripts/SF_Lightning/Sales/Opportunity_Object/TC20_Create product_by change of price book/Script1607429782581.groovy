...
WebUI.click(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC20_Create product by change of price book/Click on the choose price book button from drop down'))
...
WebUI.click(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC14_Add_Product_to_Opportunity/Click on Add products from dropdown'))
...
WebUI.setText(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC14_Add_Product_to_Opportunity/Enter quantity'), '4')
