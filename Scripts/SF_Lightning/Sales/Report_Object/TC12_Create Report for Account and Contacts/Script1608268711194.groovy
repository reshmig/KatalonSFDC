...
WebUI.click(findTestObject('SF_Lightning/Sales/Report_Object/Obj01_Create Report for Account/Page_Report Builder  Salesforce/Report_New_1st Item'))
...
WebUI.setText(findTestObject('SF_Lightning/Sales/Report_Object/Obj01_Create Report for Account/Report_Description'), 'Test Report created on Contacts & Accounts')
