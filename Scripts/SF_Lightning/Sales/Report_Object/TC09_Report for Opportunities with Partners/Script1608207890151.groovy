...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Reports_object/TC09_Report for Opportunities with Partners/select'))
...
WebUI.sendKeys(findTestObject('SF_Lightning/Sales/Reports_object/TC01_To verify that the user is able create a report for Opportunity History/Click on the Report name'), 
    'Opportunities with Partners Katalon')
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Reports_object/TC09_Report for Opportunities with Partners/verify'), 
    4)
