...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Reports_object/TC05_To verify that the user is able create a report for Opportunities with Contact Roles- Products/Select the opp contact and role of product'))
...
WebUI.sendKeys(findTestObject('SF_Lightning/Sales/Reports_object/TC01_To verify that the user is able create a report for Opportunity History/Click on the search report in list view'), 
    Keys.chord('New Report Contact and product role kat', Keys.ENTER))

WebUI.delay(2)

WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Reports_object/TC05_To verify that the user is able create a report for Opportunities with Contact Roles- Products/Verify contact and product role report'), 
    4)
