...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Reports_object/TC02_To verify that the user is able create a report for Opportunity Field History/Select opportunity field history'))
...
WebUI.sendKeys(findTestObject('SF_Lightning/Sales/Reports_object/TC01_To verify that the user is able create a report for Opportunity History/Click on the search report in list view'), 
    Keys.chord('New Opportunity Field History Report Kat', Keys.ENTER))

WebUI.delay(2)

WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Reports_object/TC02_To verify that the user is able create a report for Opportunity Field History/Verify opp field history'), 
    4)
