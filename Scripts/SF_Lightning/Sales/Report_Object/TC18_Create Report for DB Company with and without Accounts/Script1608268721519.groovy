...
WebUI.setText(findTestObject('SF_Lightning/Sales/Report_Object/Obj01_Create Report for Account/Report_Description'), 'Test Report created on D&B Company with and without Accounts')
