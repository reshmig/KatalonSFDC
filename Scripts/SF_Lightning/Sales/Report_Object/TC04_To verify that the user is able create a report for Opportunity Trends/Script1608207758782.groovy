...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Reports_object/TC04_To verify that the user is able create a report for Opportunity Trends/Select the opportunity trend'))
...
WebUI.sendKeys(findTestObject('SF_Lightning/Sales/Reports_object/TC01_To verify that the user is able create a report for Opportunity History/Click on the search report in list view'), 
    Keys.chord('New Opportunity Trends Report Kat', Keys.ENTER))

WebUI.delay(2)

WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Reports_object/TC04_To verify that the user is able create a report for Opportunity Trends/Verify trend'), 
    4)
