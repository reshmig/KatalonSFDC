...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Reports_object/TC10_Report for Opportunities with Competitors/select'))
...
WebUI.sendKeys(findTestObject('SF_Lightning/Sales/Reports_object/TC01_To verify that the user is able create a report for Opportunity History/Click on the Report name'), 
    'Opportunities with Competitors Katalon')
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Reports_object/TC10_Report for Opportunities with Competitors/verify'), 
    4)
