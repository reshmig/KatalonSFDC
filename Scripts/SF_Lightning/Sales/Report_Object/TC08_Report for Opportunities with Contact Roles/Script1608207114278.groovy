...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Reports_object/TC08_Report for Opportunities with Contact Roles/select'))
...
WebUI.sendKeys(findTestObject('SF_Lightning/Sales/Reports_object/TC01_To verify that the user is able create a report for Opportunity History/Click on the Report name'), 
    'Opportunities with Contact Role Katalon')
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Reports_object/TC08_Report for Opportunities with Contact Roles/verify'), 
    4)
