...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Reports_object/TC07_Report for Opportunities with Products/select'))
...
WebUI.sendKeys(findTestObject('SF_Lightning/Sales/Reports_object/TC01_To verify that the user is able create a report for Opportunity History/Click on the Report name'), 
    'Opportunities with Products Katalon')
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Reports_object/TC07_Report for Opportunities with Products/verify'), 
    4)
