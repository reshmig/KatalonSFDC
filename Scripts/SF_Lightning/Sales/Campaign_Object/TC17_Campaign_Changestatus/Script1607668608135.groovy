...
WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj17_Campaign_Changestatus/search'))
...
WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj17_Campaign_Changestatus/select'))

WebUI.delay(5)

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj17_Campaign_Changestatus/status'))

WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj17_Campaign_Changestatus/statussel'))

WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj17_Campaign_Changestatus/responded'))

WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj17_Campaign_Changestatus/save'))
