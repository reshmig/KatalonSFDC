...
WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj03_EditCampaignDetail/edit'))

WebUI.setText(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj01_AddCampaign/name'), 'campaigntestupdtd')
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj03_EditCampaignDetail/verify'), 5)
