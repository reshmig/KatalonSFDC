...
WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj06_CampaignCase/case'))

WebUI.setText(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj06_CampaignCase/subject'), 'campaigntest_case')

WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj06_CampaignCase/save'))

WebUI.delay(5)

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj07_CampaignContact/contactobj'))

WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj06_CampaignCase/verify'), 5)
