...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj04_CampaignDelList/delete'))

WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj04_CampaignDelList/clickok'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj01_AddCampaign/campaign'))

WebUI.verifyElementNotPresent(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj01_AddCampaign/verify'), 5)
