...
WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj08_CampaignOpportunity/opportunity'))

WebUI.setText(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj08_CampaignOpportunity/name'), 'campaigntest_opportunity')

WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj08_CampaignOpportunity/select'))

WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj08_CampaignOpportunity/prospect'))

WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj06_CampaignCase/save'))

WebUI.delay(5)

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj08_CampaignOpportunity/opporobj'))

WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj08_CampaignOpportunity/verify'), 5)
