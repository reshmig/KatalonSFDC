...
WebUI.setText(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj11_CampaignLeadmember/search'), 'Alice')

WebUI.delay(10)

WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj11_CampaignLeadmember/selAlice'))
