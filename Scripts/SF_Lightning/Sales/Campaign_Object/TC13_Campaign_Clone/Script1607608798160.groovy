...
WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj13_Campaign_Clone/clone'))

WebUI.setText(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj01_AddCampaign/name'), 'campaigntest_clone')
