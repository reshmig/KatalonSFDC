...
WebUI.click(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj14_Campaign_Owner/details'))

WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Campaign_Object/Obj14_Campaign_Owner/verify'), 0)
