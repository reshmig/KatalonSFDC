...
WebUI.click(findTestObject('SF_Lightning/Sales/Asset_Object/Obj16_Asset_DeleteCase/casesel'))

WebUI.click(findTestObject('SF_Lightning/Sales/Asset_Object/Obj16_Asset_DeleteCase/delete'))

WebUI.click(findTestObject('SF_Lightning/Sales/Asset_Object/Obj16_Asset_DeleteCase/delete2'))

WebUI.delay(5)

WebUI.click(findTestObject('SF_Lightning/Sales/Asset_Object/Obj15_Asset_EditCase/related'))

WebUI.verifyElementNotPresent(findTestObject('SF_Lightning/Sales/Asset_Object/Obj16_Asset_DeleteCase/verify'), 0)
