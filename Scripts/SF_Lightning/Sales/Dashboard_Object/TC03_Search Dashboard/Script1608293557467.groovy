...
WebUI.setText(findTestObject('SF_Lightning/Sales/Dashboard_Object/Obj01_Create Dashboard with different chart types/Dashboard_Search Field in List'), 
    'Test_Create DB with Diff Charts')

WebUI.sendKeys(findTestObject('SF_Lightning/Sales/Dashboard_Object/Obj01_Create Dashboard with different chart types/Dashboard_Search Field in List'), 
