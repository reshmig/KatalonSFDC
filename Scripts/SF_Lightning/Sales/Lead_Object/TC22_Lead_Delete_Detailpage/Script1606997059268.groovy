...
WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Delete_Detailpage/leadselect'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Delete_Detailpage/dropdown'))

WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Delete_Detailpage/deleteoption'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Delete_Detailpage/confirm'))

WebUI.delay(10)

WebUI.verifyElementNotPresent(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Delete_Detailpage/verify'), 5)
