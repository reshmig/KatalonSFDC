...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_EditEvent/newtaskdropdown'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_EditEvent/edit'))

WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_EditEvent/owner'))

WebUI.setText(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_EditEvent/ownertext'), 'Alice')

WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_EditEvent/selowner'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_EditEvent/save'))
