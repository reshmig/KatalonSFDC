...
WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_ConvertwithoutOppwithTask/withoutopp'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_ConvertwithOppWithTask/convert'))

WebUI.delay(10)

WebUI.verifyElementNotPresent(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_ConvertwithOppNoTask/chkopp'), 5)
