...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Del_NewTask/EditLeadActivity'))

WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Del_NewTask/Lead_Activity_Delete'))

WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Del_NewTask/Del_confirm'))

WebUI.delay(10)

WebUI.verifyElementNotPresent(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Del_NewTask/actverify'), 5)
