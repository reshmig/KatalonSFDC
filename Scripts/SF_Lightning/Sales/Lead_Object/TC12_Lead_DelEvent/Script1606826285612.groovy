...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_DelEvent/newtaskdropdown'))

WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_DelEvent/delete'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_DelEvent/deleteconf'))
