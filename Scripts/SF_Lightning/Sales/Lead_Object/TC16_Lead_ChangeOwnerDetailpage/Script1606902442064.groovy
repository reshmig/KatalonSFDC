...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_ConvertwithOppNoTask/editdropdown'))

WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_ChangeOwnerDetailpage/changeowner'))

WebUI.sendKeys(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_ChangeOwnerDetailpage/ownername'), 'James')

WebUI.delay(5)

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_ChangeOwnerDetailpage/selectowner'))

WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_ChangeOwnerDetailpage/submit'))
