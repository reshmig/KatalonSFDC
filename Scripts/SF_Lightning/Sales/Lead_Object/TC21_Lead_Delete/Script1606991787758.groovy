...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Delete/optionsel'))

WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Delete/seldelete'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Delete/delaccept'))
