...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Logacall/logcall'))

//WebUI.click(findTestObject('Leads/Lead_logcall_subject'))
WebUI.delay(5)

//WebUI.clearText(findTestObject('Leads/Lead_logcall_subject'))
//WebUI.delay(5)
WebUI.setText(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Logacall/subject'), 'NewLog')

WebUI.delay(5)

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Logacall/save'))
