...
WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_ChangeStatus/changestatus'))

WebUI.delay(5)

WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_ChangeStatus/statusoption'))

WebUI.delay(5)

WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_ChangeStatus/changestatussel'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_ChangeStatus/save'))

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_ChangeStatus/verifystatus'), 5)
