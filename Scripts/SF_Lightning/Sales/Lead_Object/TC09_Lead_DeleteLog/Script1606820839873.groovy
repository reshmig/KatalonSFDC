...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_DeleteLog/deletelog'))

WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_DeleteLog/delconfirm'))
