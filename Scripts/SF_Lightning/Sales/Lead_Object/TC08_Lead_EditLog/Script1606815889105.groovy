...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_EditLog/calllog_edit'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_EditLog/edit_dropdown'))

WebUI.clearText(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_EditLog/comments'))

WebUI.setText(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_EditLog/comments'), 'comments')

WebUI.click(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_EditLog/save'))
