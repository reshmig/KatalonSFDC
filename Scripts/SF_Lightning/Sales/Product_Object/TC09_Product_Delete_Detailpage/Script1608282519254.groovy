...
WebUI.click(findTestObject('SF_Lightning/Sales/Product_Object/Obj09_Product_Delete_Detailpage/select'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Product_Object/Obj06_Product_Edit_Detailpage/dropdown'))

WebUI.click(findTestObject('SF_Lightning/Sales/Product_Object/Obj09_Product_Delete_Detailpage/deletesel'))

WebUI.click(findTestObject('SF_Lightning/Sales/Product_Object/Obj08_Product_Delete_ListView/confirmdel'))

WebUI.delay(10)

WebUI.verifyElementNotPresent(findTestObject('SF_Lightning/Sales/Product_Object/Obj09_Product_Delete_Detailpage/verify'), 
    5)
