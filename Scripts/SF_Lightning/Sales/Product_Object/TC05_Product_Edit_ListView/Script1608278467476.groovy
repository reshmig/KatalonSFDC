...
WebUI.setText(findTestObject('SF_Lightning/Sales/Product_Object/Obj01_Product_CaseCreation/name'), 'newproduct_autotest_updated')
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Product_Object/Obj05_Product_EditListView/verify'), 5)
