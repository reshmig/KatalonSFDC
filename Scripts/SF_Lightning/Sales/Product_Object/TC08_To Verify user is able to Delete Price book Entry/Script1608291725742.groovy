...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Product_Object/TC08_To Verify user is able to Delete Price book Entry/click on drop down'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Product_Object/TC08_To Verify user is able to Delete Price book Entry/Click on delete from drop down'))

WebUI.delay(2)

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Product_Object/TC08_To Verify user is able to Delete Price book Entry/Click delete on pop up'))

WebUI.delay(2)

WebUI.verifyTextNotPresent('Clone Test Price Book1', false)
