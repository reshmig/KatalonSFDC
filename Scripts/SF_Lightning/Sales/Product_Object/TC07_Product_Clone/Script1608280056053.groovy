...
WebUI.click(findTestObject('SF_Lightning/Sales/Product_Object/Obj07_Product_Clone/clone'))

WebUI.setText(findTestObject('SF_Lightning/Sales/Product_Object/Obj01_Product_CaseCreation/name'), 'newproduct_autotest_clone')
