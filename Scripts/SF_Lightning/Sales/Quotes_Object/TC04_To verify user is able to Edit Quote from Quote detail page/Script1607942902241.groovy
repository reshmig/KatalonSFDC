...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Quotes_Object/TC04_To verify user is able to Edit Quote from Quote detail page/Click on the detail page'))

WebUI.delay(2)

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Quotes_Object/TC04_To verify user is able to Edit Quote from Quote detail page/Click on the edit description pencil button'))

WebUI.setText(findTestObject('SF_Lightning/Sales/Quotes_Object/TC04_To verify user is able to Edit Quote from Quote detail page/Click on the text area'), 
    'Quotes has been edited')

WebUI.click(findTestObject('SF_Lightning/Sales/Quotes_Object/TC04_To verify user is able to Edit Quote from Quote detail page/Click save on the detail page'))
