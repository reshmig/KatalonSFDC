...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Quotes_Object/TC02_To verify user is able to Edit Quote from Opportunity/Click on the product drop down'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Quotes_Object/TC05_To verify user is able to Delete Quote from Opportunity/Click delete from quotes drop down'))

WebUI.delay(3)

WebUI.click(findTestObject('SF_Lightning/Sales/Quotes_Object/TC05_To verify user is able to Delete Quote from Opportunity/Click delete from pop up'))

WebUI.delay(3)

WebUI.verifyElementNotPresent(findTestObject('SF_Lightning/Sales/Quotes_Object/TC01_To verify user is able to create quote from Opportunity/To verify Quotes'), 
    5)
