...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Quotes_Object/TC06_To verify user is able to Delete Quote by redirecting to Quote object tab from Opportunity/Click on product name'))
...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Quotes_Object/TC06_To verify user is able to Delete Quote by redirecting to Quote object tab from Opportunity/click on delete'))

WebUI.delay(3)

WebUI.click(findTestObject('SF_Lightning/Sales/Quotes_Object/TC06_To verify user is able to Delete Quote by redirecting to Quote object tab from Opportunity/Click delte from pop up'))
