...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Quotes_Object/TC10_To verify user is able to execute Stop Sync from Quote quick action/Click on the stop sync'))
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Quotes_Object/TC10_To verify user is able to execute Stop Sync from Quote quick action/Verify element unchecked or not'), 
    3)
