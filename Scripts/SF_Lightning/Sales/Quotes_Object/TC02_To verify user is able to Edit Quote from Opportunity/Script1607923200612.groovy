...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Quotes_Object/TC02_To verify user is able to Edit Quote from Opportunity/Click Edit button from the drop down'))

WebUI.delay(3)

WebUI.setText(findTestObject('SF_Lightning/Sales/Quotes_Object/TC02_To verify user is able to Edit Quote from Opportunity/Set text to the date'), 
    '03/01/2021')
