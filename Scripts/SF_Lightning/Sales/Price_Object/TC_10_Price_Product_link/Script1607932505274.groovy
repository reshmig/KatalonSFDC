...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Price_Object/Obj10_Price_Product_link/verify'), 0)

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Price_Object/Obj10_Price_Product_link/products'))

WebUI.click(findTestObject('SF_Lightning/Sales/Price_Object/Obj10_Price_Product_link/selectprod'))

WebUI.delay(5)

WebUI.click(findTestObject('SF_Lightning/Sales/Price_Object/Obj10_Price_Product_link/related2'))

WebUI.delay(5)

WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Price_Object/Obj10_Price_Product_link/verify2'), 0)
