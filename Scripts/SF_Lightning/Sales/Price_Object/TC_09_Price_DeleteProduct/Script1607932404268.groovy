...
WebUI.click(findTestObject('SF_Lightning/Sales/Price_Object/Obj09_Price_DeleteProduct/delete'))

WebUI.click(findTestObject('SF_Lightning/Sales/Price_Object/Obj09_Price_DeleteProduct/delbutton'))
