...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Contact_Object/TC27_Contact_Newtask/newtask'))
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Contact_Object/TC27_Contact_Newtask/verify'), 5)
