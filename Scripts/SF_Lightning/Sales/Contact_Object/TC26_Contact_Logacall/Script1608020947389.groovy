...
WebUI.callTestCase(findTestCase('SF_Lightning/Sales/Contact_Object/TC01_Contact_Creation'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Contact_Object/TC26_Contact_Logacall/logacall'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Contact_Object/TC26_Contact_Logacall/save'))

WebUI.delay(5)

WebUI.verifyElementPresent(findTestObject('SF_Lightning/Sales/Contact_Object/TC26_Contact_Logacall/verify'), 5)
