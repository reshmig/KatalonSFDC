...
WebUI.click(findTestObject('SF_Lightning/Service/Entitlement_Object/Obj03_Verify Entitlement Process name in Case/SC_DD_Cases'))
...
WebUI.click(findTestObject('SF_Lightning/Service/Entitlement_Object/Obj07_Verify Milesstone Criteria/Case_Details Tab'))
