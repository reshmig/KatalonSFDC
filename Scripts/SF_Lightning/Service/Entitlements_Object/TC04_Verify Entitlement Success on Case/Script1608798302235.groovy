...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Entitlement_Object/Obj04_Verify Entitlement Success on Case/Case_Mark as Complete'))

WebUI.refresh()

WebUI.verifyElementText(findTestObject('SF_Lightning/Service/Entitlement_Object/Obj04_Verify Entitlement Success on Case/Case_Subject_Title Name'), 
    'Entitlement Success Message completed')
