...
WebUI.verifyElementText(findTestObject('SF_Lightning/Service/Entitlement_Object/Obj04_Verify Entitlement Success on Case/Case_Subject_Title_Warning'), 
    'Warning action completed')
