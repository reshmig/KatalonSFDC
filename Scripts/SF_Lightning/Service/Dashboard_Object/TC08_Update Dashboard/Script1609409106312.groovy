...
WebUI.setText(findTestObject('SF_Lightning/Sales/Dashboard_Object/Obj01_Create Dashboard with different chart types/Dashboard_New_Name'), 
    'Test_Create DB for Cases with History and Solution')
...
WebUI.setText(findTestObject('SF_Lightning/Sales/Dashboard_Object/Obj01_Create Dashboard with different chart types/Add C_Search field'), 
    'New Case History Report Katalon_Test')
...
WebUI.click(findTestObject('SF_Lightning/Sales/Dashboard_Object/Obj01_Create Dashboard with different chart types/Dashboard_Edit B'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Dashboard_Object/Obj01_Create Dashboard with different chart types/Dashboard_Pencil Icon'))

WebUI.setText(findTestObject('SF_Lightning/Sales/Dashboard_Object/Obj01_Create Dashboard with different chart types/Dashboard_Pencil Icon_Title Field'), 
    'Test_UPDATED DB')
