...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC19_To verify user can able to Edit entitlement from contract related page/Click on drop down'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC19_To verify user can able to Edit entitlement from contract related page/Click on Edit'))
...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC16_To verify user can able to Edit contract line item/Click save'))

WebUI.delay(5)

WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/Contract_object/TC19_To verify user can able to Edit entitlement from contract related page/Verify entitlement'), 
    5)
