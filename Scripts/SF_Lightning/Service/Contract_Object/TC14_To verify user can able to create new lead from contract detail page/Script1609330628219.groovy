...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC14_To verify user can able to create new lead from contract detail page/Click on lead'))

WebUI.delay(3)

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Add_Manual/salutation'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC14_To verify user can able to create new lead from contract detail page/Select sal value'))

WebUI.setText(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Add_Manual/lastname'), 'Kumar')

WebUI.setText(findTestObject('SF_Lightning/Sales/Lead_Object/Obj_Lead_Add_Manual/company'), 'Marlabs')

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC13_To verify user can able to create new opportunity from contract detail page/Click on save'))
...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC14_To verify user can able to create new lead from contract detail page/Click on lead object'))

WebUI.delay(5)

WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/Contract_object/TC14_To verify user can able to create new lead from contract detail page/Verify lead'), 
    3)
