...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC05_To verify user can able to clone the contract/Click on Clone'))
...
WebUI.setText(findTestObject('SF_Lightning/Service/Contract_object/TC05_To verify user can able to clone the contract/Set text in description'), 
    'clone')
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/Contract_object/TC05_To verify user can able to clone the contract/Verify clone'), 
    3)
