...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC18_To verify user can able to create entitlement from contract realated page/Click on new button'))

WebUI.delay(5)

WebUI.setText(findTestObject('SF_Lightning/Service/Contract_object/TC18_To verify user can able to create entitlement from contract realated page/Set text in name field'), 
    'Test Entitlement')

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC18_To verify user can able to create entitlement from contract realated page/Click on Account field'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC18_To verify user can able to create entitlement from contract realated page/Select account'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC18_To verify user can able to create entitlement from contract realated page/Click on save'))

WebUI.delay(5)

WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/Contract_object/TC18_To verify user can able to create entitlement from contract realated page/Verify entitlement'), 
    5)
