...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC10_To verify user can able to log a call/Click log a call'))

WebUI.setText(findTestObject('SF_Lightning/Service/Contract_object/TC10_To verify user can able to log a call/Set text to comment'), 
    'Test for call')
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/Contract_object/TC10_To verify user can able to log a call/Verify log a call'), 
    5)
