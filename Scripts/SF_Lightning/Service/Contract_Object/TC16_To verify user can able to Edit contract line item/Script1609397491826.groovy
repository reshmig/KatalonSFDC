...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC16_To verify user can able to Edit contract line item/Click on Edit'))

WebUI.delay(5)

WebUI.setText(findTestObject('SF_Lightning/Service/Contract_object/TC16_To verify user can able to Edit contract line item/Set text in description'), 
    'Test')
