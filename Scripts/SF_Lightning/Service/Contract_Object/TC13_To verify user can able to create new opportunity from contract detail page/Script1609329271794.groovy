...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC13_To verify user can able to create new opportunity from contract detail page/Click opportunity'))
...
WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC01_Opportunity_add_manual_home page/stage values'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC01_Opportunity_add_manual_home page/select stage value prospecting'))
...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC13_To verify user can able to create new opportunity from contract detail page/Click on Opportunity object'))

WebUI.delay(5)

WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/Contract_object/TC13_To verify user can able to create new opportunity from contract detail page/Verify opp'), 
    3)
