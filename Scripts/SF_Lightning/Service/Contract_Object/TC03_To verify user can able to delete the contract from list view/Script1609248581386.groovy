...
WebUI.sendKeys(findTestObject('SF_Lightning/Service/Contract_object/TC02_To verify user can able to edit the contract from list view/Click on the search field'), 
    Keys.chord('Test for contract', Keys.ENTER))

WebUI.delay(3)

WebUI.enhancedClick(findTestObject('SF_Lightning/Sales/Opportunity_Object/TC02_Opportunity_Edit_ListView/Click on the drop down'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC03_To verify user can able to delete the contract from list view/Click on Delete'))

WebUI.delay(3)

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC03_To verify user can able to delete the contract from list view/Click delete from pop up'))

WebUI.delay(3)

WebUI.verifyElementNotPresent(findTestObject('SF_Lightning/Service/Contract_object/TC01_To verify user can able to create contract/Verify contract'), 
    3)
