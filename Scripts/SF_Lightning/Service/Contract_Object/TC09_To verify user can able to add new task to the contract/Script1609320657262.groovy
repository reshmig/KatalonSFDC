...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC09_To verify user can able to add new task to the contract/Click on New task'))

WebUI.delay(5)

WebUI.sendKeys(findTestObject('SF_Lightning/Service/Contract_object/TC08_To verify that user can able to add event to the contract/Set text on subject'), 
    Keys.chord('Email', Keys.ENTER))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC08_To verify that user can able to add event to the contract/Click on save'))

WebUI.delay(5)

WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/Contract_object/TC09_To verify user can able to add new task to the contract/Verify Task'), 
    5)
