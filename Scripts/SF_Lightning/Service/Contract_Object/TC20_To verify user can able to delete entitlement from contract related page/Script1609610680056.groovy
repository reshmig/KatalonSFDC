...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC20_To verify user can able to delete entitlement from contract related page/Click on drop down'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC20_To verify user can able to delete entitlement from contract related page/Click on delete'))

WebUI.delay(3)

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC20_To verify user can able to delete entitlement from contract related page/Click on delete pop up'))

WebUI.delay(3)

WebUI.verifyElementNotPresent(findTestObject('SF_Lightning/Service/Contract_object/TC19_To verify user can able to Edit entitlement from contract related page/Verify entitlement'), 
    4)
