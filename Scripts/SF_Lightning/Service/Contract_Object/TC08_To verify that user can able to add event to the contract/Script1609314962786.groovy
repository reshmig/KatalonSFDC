...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Contract_object/TC08_To verify that user can able to add event to the contract/Click on add'))
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/Contract_object/TC08_To verify that user can able to add event to the contract/Verify event'), 
    5)
