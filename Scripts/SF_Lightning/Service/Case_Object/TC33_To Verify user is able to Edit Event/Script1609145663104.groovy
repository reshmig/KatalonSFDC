...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/TC33_To Verify user is able to Edit Event/Click on Edit'))

WebUI.delay(3)

WebUI.setText(findTestObject('SF_Lightning/Service/Case_Object/TC33_To Verify user is able to Edit Event/Set location'), 
    'India')

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/TC33_To Verify user is able to Edit Event/Click on Save'))
