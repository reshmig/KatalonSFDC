...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj_Clone a Case record/Case_DD_Clone B'))
...
WebUI.click(findTestObject('SF_Lightning/Service/Case_Object/Obj_Clone a Case record/Case_Drop down 2'))
