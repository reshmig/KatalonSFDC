...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/TC31_To Verify user is able to Delete logged call/Click on Delete button'))

WebUI.delay(3)

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/TC31_To Verify user is able to Delete logged call/Click delete from pop up'))
...
WebUI.verifyElementNotPresent(findTestObject('SF_Lightning/Service/Case_Object/TC29_To Verify user is able to Create Log a Call under Activity/Verify call log'), 
    4)
