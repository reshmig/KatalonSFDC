...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj_Create a task_From Case record/Case_New Task Tab'))
...
WebUI.setText(findTestObject('SF_Lightning/Service/Case_Object/Obj_Create a task_From Case record/Case_Task_Due Date'), 
    '12/28/2020')

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj_Create a task_From Case record/Case_Task_Save B'))
...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj_Edit a task_From Case record/Case_Task_Email item'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj_Edit a task_From Case record/Case_Task_Email_Drop Down'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj_Edit a task_From Case record/Case_Task_Email_DD_Edit B'))

WebUI.setText(findTestObject('SF_Lightning/Service/Case_Object/Obj_Edit a task_From Case record/Case_Task_Email_Comment'), 'Updated the current task')

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj_Edit a task_From Case record/Case_Task_Email_Save B'))
...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj_Edit a task_From Case record/Case_Task_Email_Related To field'))
