...
WebUI.sendKeys(findTestObject('SF_Lightning/Service/Case_Object/Obj_Case_ChangeOwner_QueuetoUser_ListView/search'), Keys.chord(
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/Case_Object/Obj_Case_ChangeOwner_QueuetoUser_ListView/verify'), 
    0)
