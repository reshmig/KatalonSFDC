...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj_To Verify user is able to create new Event/click on new event'))

WebUI.delay(3)

WebUI.sendKeys(findTestObject('SF_Lightning/Service/Case_Object/Obj_To Verify user is able to create new Event/Click on subject field'), 
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/Case_Object/Obj_To Verify user is able to create new Event/Verify event call'), 
    5)
