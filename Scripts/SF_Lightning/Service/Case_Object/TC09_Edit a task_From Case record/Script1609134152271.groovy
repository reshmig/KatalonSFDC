...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj09_Edit a task_From Case record/Case_Task_Email_DD_Edit B'))

WebUI.setText(findTestObject('SF_Lightning/Service/Case_Object/Obj09_Edit a task_From Case record/Case_Task_Email_Comment'), 'Updated the current task')

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj09_Edit a task_From Case record/Case_Task_Email_Save B'))
...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj09_Edit a task_From Case record/Case_Task_Email_Related To field'))
