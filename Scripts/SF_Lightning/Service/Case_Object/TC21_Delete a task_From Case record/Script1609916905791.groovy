...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj_Delete a task_From Case record/Case_Task_Email_Delete'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj_Delete a task_From Case record/Case_task_Email_Confirm Delete'))
