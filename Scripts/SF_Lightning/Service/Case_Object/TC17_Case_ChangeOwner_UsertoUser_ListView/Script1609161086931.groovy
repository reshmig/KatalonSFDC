...
WebUI.sendKeys(findTestObject('SF_Lightning/Service/Case_Object/Obj_Case_ChangeOwner_UsertoUser_ListView/search'), Keys.chord(
        'Change Case Owner01', Keys.ENTER))
...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj_Case_ChangeOwner_UsertoUser_ListView/people'))

WebUI.delay(5)

WebUI.click(findTestObject('SF_Lightning/Service/Case_Object/Obj08_Case_QueueVerification/queuename'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('SF_Lightning/Service/Case_Object/Obj08_Case_QueueVerification/queuename'), 'QA Katalon')

WebUI.delay(5)

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj_Case_ChangeOwner_UsertoUser_ListView/userselect'))
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/Case_Object/Obj_Case_ChangeOwner_UsertoUser_ListView/verify'), 
    0)
