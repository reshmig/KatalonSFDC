...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Case_Object/Obj_CaseEdit_Listview/selectcase'))

WebUI.delay(5)

WebUI.click(findTestObject('SF_Lightning/Service/Case_Object/Obj_CaseEdit_Listview/edit'))

WebUI.setText(findTestObject('SF_Lightning/Service/Case_Object/Obj_Service_Createcase/subject'), 'Service Cloud case_updated')
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/Case_Object/Obj_CaseEdit_Listview/verify'), 0)
