...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Tasks_Object/Obj05_Updatetask_Status/statusdropdown'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Tasks_Object/Obj05_Updatetask_Status/notstarted'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Tasks_Object/Obj05_Updatetask_Status/inprogress'))

WebUI.delay(5)

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Tasks_Object/Obj05_Updatetask_Status/save'))
