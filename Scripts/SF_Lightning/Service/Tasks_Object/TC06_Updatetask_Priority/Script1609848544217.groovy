...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Tasks_Object/Obj06_Updatetask_Priority/priority'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Tasks_Object/Obj06_Updatetask_Priority/selpriority'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Tasks_Object/Obj06_Updatetask_Priority/low'))
