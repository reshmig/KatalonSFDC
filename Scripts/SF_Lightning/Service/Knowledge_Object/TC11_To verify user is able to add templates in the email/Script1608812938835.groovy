...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Knowledge_Object/TC11_To verify user is able to add templates in the email/Click on email'))

WebUI.delay(3)

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Knowledge_Object/TC11_To verify user is able to add templates in the email/Click on send'))

WebUI.delay(3)

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Knowledge_Object/TC11_To verify user is able to add templates in the email/Click on email tab for verify'))
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/Knowledge_Object/TC11_To verify user is able to add templates in the email/Verify email element'), 
    5)
