...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Knowledge_Object/TC15_To verify user is able to delete article from detail page/Click on delete draft'))

WebUI.delay(3)

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Knowledge_Object/TC15_To verify user is able to delete article from detail page/Click on delete'))
...
WebUI.verifyElementNotPresent(findTestObject('SF_Lightning/Service/Knowledge_Object/TC12_To verify user is able to Edit article from list view/Verify edit'), 
    4)
