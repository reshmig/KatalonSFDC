...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Knowledge_Object/TC08_To verify user is able to deattach article to a case/Click on the deattach article from drop down'))
...
WebUI.verifyElementNotPresent(findTestObject('SF_Lightning/Service/Knowledge_Object/TC07_To verify user is able to attach article to a case/Verify article attached or not'), 
    3)
