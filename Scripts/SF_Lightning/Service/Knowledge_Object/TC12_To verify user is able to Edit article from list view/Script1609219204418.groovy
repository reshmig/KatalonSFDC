...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Knowledge_Object/TC12_To verify user is able to Edit article from list view/Select edit from drop down'))
