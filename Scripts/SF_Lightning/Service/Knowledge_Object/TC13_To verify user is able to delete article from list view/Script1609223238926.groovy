...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Knowledge_Object/TC13_To verify user is able to delete article from list view/Click delete draft from drop down'))

WebUI.delay(3)

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Knowledge_Object/TC13_To verify user is able to delete article from list view/Click on delete button from pop up'))
