...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Report_Object/Obj09_Caseswithsolutioncategories_Report/selreport'))
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/Report_Object/Obj09_Caseswithsolutioncategories_Report/verify'), 
    4)
