...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Report_Object/Obj07_CaseswithMilestones_Report/reportselect'))
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/Report_Object/Obj07_CaseswithMilestones_Report/verify'), 
    4)
