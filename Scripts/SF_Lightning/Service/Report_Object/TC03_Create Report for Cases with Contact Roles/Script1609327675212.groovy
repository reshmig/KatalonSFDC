...
WebUI.setText(findTestObject('SF_Lightning/Sales/Report_Object/Obj01_Create Report for Account/Report_Description'), 'Test Report created on Cases with Contact Roles')
...
WebUI.verifyElementText(findTestObject('SF_Lightning/Service/Report_Object/Obj01_Create Report for Cases/Report_List View_1st Item'), 
    'New Cases with Contact Roles Report_Test')
