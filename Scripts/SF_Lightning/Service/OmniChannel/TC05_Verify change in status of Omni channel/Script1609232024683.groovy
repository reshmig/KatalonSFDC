...
WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Omni Channel/Obj05_Verify change in status of Omni channel/OC_Status_Busy'))

WebUI.delay(3)

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Omni Channel/Obj05_Verify change in status of Omni channel/OC_Status Drop Down'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Omni Channel/Obj05_Verify change in status of Omni channel/OC_Status_On Break'))

WebUI.delay(3)

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Omni Channel/Obj05_Verify change in status of Omni channel/OC_Status Drop Down'))

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/Omni Channel/Obj05_Verify change in status of Omni channel/OC_Status_Offline'))
