...
WebUI.click(findTestObject('SF_Lightning/Service/OmniChannel/Obj01_Omnichannel_CaseAssignment/mytask'))

WebUI.click(findTestObject('SF_Lightning/Service/OmniChannel/Obj02_Omnichannel_Acceptcase/accept'))

WebUI.delay(5)

WebUI.enhancedClick(findTestObject('SF_Lightning/Service/OmniChannel/Obj01_Omnichannel_CaseAssignment/omnichannel'))

WebUI.delay(3)

WebUI.click(findTestObject('SF_Lightning/Service/OmniChannel/Obj02_Omnichannel_Acceptcase/mywork'))

WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/OmniChannel/Obj02_Omnichannel_Acceptcase/verify'), 0)
