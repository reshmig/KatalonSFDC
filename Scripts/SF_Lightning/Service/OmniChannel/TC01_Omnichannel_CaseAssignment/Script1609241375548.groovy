...
WebUI.check(findTestObject('SF_Lightning/Service/OmniChannel/Obj01_Omnichannel_CaseAssignment/checkassign'))
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/OmniChannel/Obj01_Omnichannel_CaseAssignment/verify'), 0)
...
WebUI.verifyElementPresent(findTestObject('SF_Lightning/Service/OmniChannel/Obj01_Omnichannel_CaseAssignment/checkcase'), 
    5)
